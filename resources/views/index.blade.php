        ...
        <div class="container">
            <div class="mx-10">
                ...
                <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-10 justify-center items-center">
                    ...
                    <a class='group' href="{{ route('second',['pages','index-1']) }}" target='_blank'>
                    ...
                    <a class='group' href="{{ route('second',['pages','index-2']) }}" target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <a class='group' href="{{ route('second',['pages','index-3']) }}" target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <a class='group' href="{{ route('second',['pages','index-4']) }}" target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <a class='group' href="{{ route('second',['pages','index-5']) }}" target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <a class='group' href="{{ route('second',['pages','index-6']) }}" target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <div class="lg:col-span-2">
                        <div class="flex justify-center">
                            <div class="lg:w-1/2">
                                <a class='group' href="{{ route('second',['pages','index-7']) }}" target='_blank'>
                                    <div class="rounded-xl overflow-hidden border border-gray-200">
