<?php $__env->startSection('css'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['node_modules/swiper/swiper-bundle.min.css','node_modules/glightbox/dist/css/glightbox.min.css']); ?>
        ...
        <div class="container">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 items-center">
                ...
                <div class="mt-4 pt-2 sm:mt-0 sm:pt-0 relative">
                    <img src="/images/furniture.png" alt="" class="h-[600px] max-w-full mx-auto">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/krushant/Downloads/Evea_laravel/resources/views/pages/index-1.blade.php ENDPATH**/ ?>