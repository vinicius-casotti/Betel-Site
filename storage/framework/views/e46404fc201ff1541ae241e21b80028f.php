<?php $__env->startSection('content'); ?>
    ...
    <!-- =========== Hero Section Start =========== -->
    <section class="relative pt-32 pb-32 overflow-x-hidden bg-[url(/public/images/bg-demo.jpg)] bg-no-repeat bg-cover" id="home">
        <div class="container">
            ...
            <div class="text-center mt-16">
                ...
                <div class="inline-flex flex-wrap items-center justify-center gap-4">
                    <div class="w-16 h-16 flex justify-center items-center rounded-md bg-white">
                        <img src="/images/frame/tailwind.png" class="w-9 h-9">
                    </div>
                    <div class="w-16 h-16 flex justify-center items-center rounded-md bg-white">
                        <img src="/images/frame/html.svg" class="w-9 h-9">
                    </div>
                    <div class="w-16 h-16 flex justify-center items-center rounded-md bg-white">
                        <img src="/images/frame/css.svg" class="w-9 h-9">
                    </div>
                    <div class="w-16 h-16 flex justify-center items-center rounded-md bg-white">
                        <img src="/images/frame/javascript.svg" class="w-9 h-9">
                    </div>
                    <div class="w-16 h-16 flex justify-center items-center rounded-md bg-white">
                        <img src="/images/frame/scss2.png" class="w-9 h-9">
                    </div>
                    <div class="w-16 h-16 flex justify-center items-center rounded-md bg-white">
                        <img src="/images/frame/yarn.png" class="w-9 h-9">
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="mx-10">
                ...
                <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-10 justify-center items-center">
                    ...
                    <a class='group' href="<?php echo e(route('second',['pages','index-1'])); ?>" target='_blank'>
                    ...
                    <a class='group' href="<?php echo e(route('second',['pages','index-2'])); ?>" target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <a class='group' href="<?php echo e(route('second',['pages','index-3'])); ?>" target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <a class='group' href="<?php echo e(route('second',['pages','index-4'])); ?>" target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <a class='group' href="<?php echo e(route('second',['pages','index-5'])); ?>" target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <a class='group' href="<?php echo e(route('second',['pages','index-6'])); ?>" target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <div class="lg:col-span-2">
                        <div class="flex justify-center">
                            <div class="lg:w-1/2">
                                <a class='group' href="<?php echo e(route('second',['pages','index-7'])); ?>" target='_blank'>
                                    <div class="rounded-xl overflow-hidden border border-gray-200">
    ...
    <footer class="relative  bg-[url(/public/images/bg-demo.jpg)] bg-no-repeat bg-cover">
...
<!-- Back to top -->
<a id="back-to-top" class="back-to-top fixed text-base rounded-md z-10 bottom-8 right-8 h-8 w-8 text-center bg-primary text-white leading-9 justify-center items-center">
    <i data-lucide="arrow-up" class="h-4 w-4 text-white stroke-2"></i>
</a>
<!-- Back to top -->
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Projetos\evea-app-laravel-landing-page-template-2025-04-16-13-34-28-utc\Evea_Laravel_v1.0.0\Evea\resources\views/index.blade.php ENDPATH**/ ?>