...
<head>
    <?php echo $__env->make("partials/title-meta", ["title"  => "Evea"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<body>
        ...
        <div class="container">
            <div class="mx-10">
                ...
                <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-10 justify-center items-center">
                    ...
                    <a class='group' href='index-1.html' target='_blank'>
                    ...
                    <a class='group' href='index-2.html' target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <a class='group' href='index-3.html' target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <a class='group' href='index-4.html' target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <a class='group' href='index-5.html' target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <a class='group' href='index-6.html' target='_blank'>
                        <div class="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <div class="lg:col-span-2">
                        <div class="flex justify-center">
                            <div class="lg:w-1/2">
                                <a class='group' href='index-7.html' target='_blank'>
                                    <div class="rounded-xl overflow-hidden border border-gray-200">
    ...
    <?php echo $__env->make("partials/back-to-top", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->make("partials/script-file", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

</body>

</html><?php /**PATH /home/ct/Prac/evea_laravel/resources/views/index.blade.php ENDPATH**/ ?>