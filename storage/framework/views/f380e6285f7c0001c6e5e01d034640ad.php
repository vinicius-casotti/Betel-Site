...
<nav class="navbar fixed top-0 start-0 end-0 z-999 transition-all duration-500 py-5 items-center shadow-md lg:shadow-none [&.is-sticky]:bg-white group [&.is-sticky]:shadow-md bg-white lg:bg-transparent" id="navbar">
    <div class="container">
        ...
        <div class="flex lg:flex-nowrap flex-wrap items-center">
            ...
            <a href="<?php echo e(route('any', 'index')); ?>" class="flex items-center">
...
<?php /**PATH C:\laragon\www\Projetos\evea-app-laravel-landing-page-template-2025-04-16-13-34-28-utc\Evea_Laravel_v1.0.0\Evea\resources\views/layouts/partials/nav-dark.blade.php ENDPATH**/ ?>