...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Navbar Start -->
    <?php echo $__env->make('layouts.partials/nav-light', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- Navbar End -->

    <!-- Hero Start -->
    <section class="relative pt-44 from-slate-500/10 bg-[url(/public/images/home/bg-2.png)] bg-no-repeat bg-cover" id="home">
        <div class="container">
...
<?php $__env->startSection('script_bottom'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/swiper.js','resources/js/app.js']); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/krushant/Downloads/Evea_laravel-1/resources/views/pages/index-2.blade.php ENDPATH**/ ?>